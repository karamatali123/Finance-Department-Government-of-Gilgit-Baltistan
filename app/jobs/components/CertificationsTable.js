...
const CertificationsTable = ({ certifications, handleDeleteCertification }) => {
  const headers = [
    "Certification",
  ...
  return (
    <div className="w-full p-4">
      <h3 className="text-2xl font-bold text-gray-900 my-4">Certifications</h3>
        ...
        <tbody className="text-gray-600 text-[16px] font-light">
          {certifications.length > 0 ? (
            certifications.map((item, index) => (
              ...
              >
                <td className="py-5 px-6 text-left ">{item.certification}</td>
                <td className="py-5 px-6 text-left ">
                  {item.certificationProvider}
                </td>
                <td className="py-5 px-6 text-left ">
