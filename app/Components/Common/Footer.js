      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              The Finance Department is responsible for supervision and control
              of provincial finances, preparation of provincial budget,
              formulation of Financial Rules and Civil Services Rules relating
              to pay, perquisite and pension of civil servants...
            </p>
            <a
              href="#"
