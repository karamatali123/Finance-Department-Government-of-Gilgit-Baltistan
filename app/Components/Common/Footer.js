        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="mt-4 max-w-[300px] mx-auto md:mx-0">
                <Image
                  src={frame}
                  alt="Sample image"
                  width={300}
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-400 text-sm sm:text-base max-w-md mx-auto md:mx-0">
                The Finance Department is responsible for supervision and
                control of provincial finances, preparation of provincial
                budget, formulation of Financial Rules and Civil Services Rules
                relating to pay, perquisite and pension of civil servants...
              </p>
              <a
                href="#"
                className="text-primary hover:underline mt-4 inline-block text-sm sm:text-base"
              >
                Read More
              </a>
            </div>
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base text-gray-400 max-w-md mx-auto lg:mx-0">
                Finance Department, Government of the Gilgit Baltistan
              </p>
              <div className="mt-4 space-y-4 max-w-md mx-auto lg:mx-0">
